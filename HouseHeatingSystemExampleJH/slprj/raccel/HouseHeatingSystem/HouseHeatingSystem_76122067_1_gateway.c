...
void HouseHeatingSystem_76122067_1_gateway ( void ) { NeModelParameters
modelparams = { ( NeSolverType ) 0 , 0.001 , 0.001 , 0.001 , 1 , 0 , (
NeModifyAbsTol ) 0 , 0.001 , 0 , 0 , 0 , 0 , ( SscLoggingSetting ) 1 ,
618863391 , 0 , 0 , 0 , } ; NeSolverParameters solverparams = { 0 , 0 , 1 , 0
, 0 , 0.001 , 1e-06 , 1e-09 , 0 , 0 , 100 , 0 , 1 , ( NeConsistencySolver ) 2
, ( NeIndexReductionMethod ) 1 , 0 , 1e-09 , ( NeToleranceSource ) 1 , 0.001
, 0.001 , 0.001 , 0 , ( NeLocalSolverChoice ) 0 , 1 , 1 , 0.1 , 0 , 3 , 2 , 0
...
sizeof ( outputparameters_init [ 0 ] ) ; } HouseHeatingSystem_76122067_1_dae
( & dae , & modelparams , & solverparams ) ; nesl_register_simulator_group (
"HouseHeatingSystem/Solver Configuration_1" , 1 , & dae , & solverparams , &
