...
rtBTransitions [ ] = { { ( char_T * ) ( & rtB . jcuxftpgbe [ 0 ] ) , 0 , 0 ,
246 } , { ( char_T * ) ( & rtDW . akwnajywu4 [ 0 ] ) , 0 , 0 , 14 } , { (
char_T * ) ( & rtDW . j32iztpw5z ) , 11 , 0 , 16 } , { ( char_T * ) ( & rtDW
. ilpkpitgbn [ 0 ] ) , 10 , 0 , 83 } , { ( char_T * ) ( & rtDW . ewxx0epgrq )
, 6 , 0 , 1 } , { ( char_T * ) ( & rtDW . gprv1nclhs ) , 8 , 0 , 4 } } ;
static DataTypeTransitionTable rtBTransTable = { 6U , rtBTransitions } ;
static DataTypeTransition rtPTransitions [ ] = { { ( char_T * ) ( & rtP .
NG_density ) , 0 , 0 , 37 } } ; static DataTypeTransitionTable rtPTransTable
= { 1U , rtPTransitions } ;
