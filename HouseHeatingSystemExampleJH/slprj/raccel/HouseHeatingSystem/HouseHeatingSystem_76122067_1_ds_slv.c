...
#include "HouseHeatingSystem_76122067_1_ds_slv.h"
...
int32_T HouseHeatingSystem_76122067_1_ds_slv ( const NeDynamicSystem * LC ,
...
mSLV ; for ( b = 0 ; b < 131 ; b ++ ) { t0 [ b ] = _cg_const_1 [ b ] ; } for
( b = 0 ; b < 131 ; b ++ ) { out . mX [ b ] = t0 [ b ] ; } ( void ) LC ; (
void ) t2 ; return 0 ; }
