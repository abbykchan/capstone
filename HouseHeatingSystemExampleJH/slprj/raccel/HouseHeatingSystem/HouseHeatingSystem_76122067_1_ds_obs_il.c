...
#include "HouseHeatingSystem_76122067_1_ds_obs_il.h"
...
int32_T HouseHeatingSystem_76122067_1_ds_obs_il ( const NeDynamicSystem * LC
, const NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) { static
boolean_T _cg_const_1 [ 820 ] = { true , false , false , true , false , true
...
, true , true , true , true , true , false , true , true , true , true ,
false , false , false , true , true , true , true , true , true , true , true
, true , true } ; PmBoolVector out ; int32_T b ; boolean_T t0 [ 820 ] ; (
void ) t1 ; ( void ) LC ; out = t2 -> mOBS_IL ; for ( b = 0 ; b < 820 ; b ++
) { t0 [ b ] = _cg_const_1 [ b ] ; } for ( b = 0 ; b < 820 ; b ++ ) { out .
