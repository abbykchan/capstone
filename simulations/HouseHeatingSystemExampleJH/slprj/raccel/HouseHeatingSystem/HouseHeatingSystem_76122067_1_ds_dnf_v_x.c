...
#include "HouseHeatingSystem_76122067_1_ds_dnf_v_x.h"
...
int32_T HouseHeatingSystem_76122067_1_ds_dnf_v_x ( const NeDynamicSystem * LC
, const NeDynamicSystemInput * t1 , NeDsMethodOutput * t2 ) { static
boolean_T _cg_const_1 [ 131 ] = { true , true , true , true , true , true ,
...
false , false } ; PmBoolVector out ; int32_T b ; boolean_T t0 [ 131 ] ; (
void ) t1 ; ( void ) LC ; out = t2 -> mDNF_V_X ; for ( b = 0 ; b < 131 ; b ++
) { t0 [ b ] = _cg_const_1 [ b ] ; } for ( b = 0 ; b < 131 ; b ++ ) { out .
