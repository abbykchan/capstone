...
#include "HouseHeatingSystem_76122067_1_ds_obs_act.h"
...
int32_T HouseHeatingSystem_76122067_1_ds_obs_act ( const NeDynamicSystem * LC
...
; b ++ ) { X [ b ] = t18 -> mX . mX [ b ] ; } out = t19 -> mOBS_ACT ;
